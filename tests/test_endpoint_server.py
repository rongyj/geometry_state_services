...
class StateEndpointHTTPRequestTestSuite(unittest.TestCase):
    ...
    def test_endpoint_request(self):
        server = HTTPServer((socket.gethostbyname("localhost"), 9595), services.http.server.StatesHTTPRequestHandler)
        ...
        endpoint_server = HTTPServer((socket.gethostbyname("localhost"), 8080), services.http.endpoint.StateEndpointHTTPRequestHandler)
